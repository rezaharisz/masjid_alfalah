...
loadjs.ready("head", function () {
    ...
    fkhatibadd = currentForm = new ew.Form("fkhatibadd", "add");

    // Add fields
    var fields = ew.vars.tables.khatib.fields;
    fkhatibadd.addFields([
    ...
    // Form_CustomValidate
    fkhatibadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fkhatibadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fkhatibadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fkhatibadd" id="fkhatibadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fkhatibadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fkhatibadd", "x_TANGGAL_KHOTBAH", {"ignoreReadonly":true,"useCurrent":false,"format":7});
});
</script>
<?php } ?>
</span>
