...
loadjs.ready("head", function () {
    ...
    // Validate form
    fpengurus_masjidadd.validate = function () {
    ...
    // Form_CustomValidate
    fpengurus_masjidadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpengurus_masjidadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fpengurus_masjidadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpengurus_masjidadd" id="fpengurus_masjidadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fpengurus_masjidadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpengurus_masjidadd", "x_TGL_LAHIR", {"ignoreReadonly":true,"useCurrent":false,"format":7});
});
</script>
<?php } ?>
</span>
