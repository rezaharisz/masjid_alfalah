...
loadjs.ready("head", function () {
    ...
    fbarangedit.lists.KONDISI = <?= $Page->KONDISI->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fbarangedit" id="fbarangedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<input type="hidden" data-table="barang" data-field="x_NAMA_BARANG" data-hidden="1" name="o_NAMA_BARANG" id="o_NAMA_BARANG" value="<?= HtmlEncode($Page->NAMA_BARANG->OldValue ?? $Page->NAMA_BARANG->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fbarangedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fbarangedit", "x_TANGGAL_PEMBELIAN", {"ignoreReadonly":true,"useCurrent":false,"format":7});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fbarangedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fbarangedit", "x_TANGGAL_BELI_GANTI_BARU", {"ignoreReadonly":true,"useCurrent":false,"format":7});
});
</script>
<?php } ?>
</span>
