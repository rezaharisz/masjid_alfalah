...
<?php if ($Page->userlevelid->Visible) { // userlevelid ?>
        <th data-name="userlevelid" class="<?= $Page->userlevelid->headerCellClass() ?>"><div id="elh_users_userlevelid" class="users_userlevelid"><?= $Page->renderSort($Page->userlevelid) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_users_userlevelid">
