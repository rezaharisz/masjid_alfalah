...
var fperlengkapan_ibadahedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fperlengkapan_ibadahedit = currentForm = new ew.Form("fperlengkapan_ibadahedit", "edit");

    // Add fields
    var fields = ew.vars.tables.perlengkapan_ibadah.fields;
    fperlengkapan_ibadahedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fperlengkapan_ibadahedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fperlengkapan_ibadahedit.validate = function () {
    ...
    // Form_CustomValidate
    fperlengkapan_ibadahedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fperlengkapan_ibadahedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fperlengkapan_ibadahedit.lists.KONDISI = <?= $Page->KONDISI->toClientList($Page) ?>;
    loadjs.done("fperlengkapan_ibadahedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fperlengkapan_ibadahedit" id="fperlengkapan_ibadahedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<input type="hidden" data-table="perlengkapan_ibadah" data-field="x_NAMA_PERLENGKAPAN_IBADAH" data-hidden="1" name="o_NAMA_PERLENGKAPAN_IBADAH" id="o_NAMA_PERLENGKAPAN_IBADAH" value="<?= HtmlEncode($Page->NAMA_PERLENGKAPAN_IBADAH->OldValue ?? $Page->NAMA_PERLENGKAPAN_IBADAH->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fperlengkapan_ibadahedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fperlengkapan_ibadahedit", "x_TANGGAL_PEMBELIAN", {"ignoreReadonly":true,"useCurrent":false,"format":7});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fperlengkapan_ibadahedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fperlengkapan_ibadahedit", "x_TANGGAL_BELI_GANTI_BARU", {"ignoreReadonly":true,"useCurrent":false,"format":7});
});
</script>
<?php } ?>
</span>
