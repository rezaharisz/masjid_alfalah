...
<link rel="shortcut icon" type="image/x-icon" href="<?= BasePath() ?>/Icons8-Ios7-Cultures-Mosque.ico">
<link rel="icon" type="image/x-icon" href="<?= BasePath() ?>/Icons8-Ios7-Cultures-Mosque.ico">
    ...
    <nav class="<?= Config("NAVBAR_CLASS") ?>">
        ...
        <ul id="ew-navbar" class="navbar-nav">
            ...
            <a class="navbar-brand d-none" href="#"  onclick="return false;">
                <span class="brand-text">Masjid Al-Falah Kaligetas</span>
            </a>
        </ul>
        <!-- Right navbar links -->
