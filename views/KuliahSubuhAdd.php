...
var fkuliah_subuhadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fkuliah_subuhadd = currentForm = new ew.Form("fkuliah_subuhadd", "add");

    // Add fields
    var fields = ew.vars.tables.kuliah_subuh.fields;
    fkuliah_subuhadd.addFields([
    ...
    // Validate form
    fkuliah_subuhadd.validate = function () {
    ...
    // Form_CustomValidate
    fkuliah_subuhadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fkuliah_subuhadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fkuliah_subuhadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fkuliah_subuhadd" id="fkuliah_subuhadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fkuliah_subuhadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fkuliah_subuhadd", "x_TANGGAL", {"ignoreReadonly":true,"useCurrent":false,"format":7});
});
</script>
<?php } ?>
</span>
