 ...
 * Page class
 */
class KuliahSubuhDelete extends KuliahSubuh
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KuliahSubuhDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("kuliahsubuhlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("kuliahsubuhlist"); // Return to list
                return;
            }
        }
