 ...
 * Page class
 */
class PerlengkapanIbadahEdit extends PerlengkapanIbadah
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PerlengkapanIbadahEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("NAMA_PERLENGKAPAN_IBADAH") ?? Key(0) ?? Route(2)) !== null) {
                $this->NAMA_PERLENGKAPAN_IBADAH->setQueryStringValue($keyValue);
                $this->NAMA_PERLENGKAPAN_IBADAH->setOldValue($this->NAMA_PERLENGKAPAN_IBADAH->QueryStringValue);
            } elseif (Post("NAMA_PERLENGKAPAN_IBADAH") !== null) {
                $this->NAMA_PERLENGKAPAN_IBADAH->setFormValue(Post("NAMA_PERLENGKAPAN_IBADAH"));
                $this->NAMA_PERLENGKAPAN_IBADAH->setOldValue($this->NAMA_PERLENGKAPAN_IBADAH->FormValue);
            } else {
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_NAMA_PERLENGKAPAN_IBADAH")) {
            $this->NAMA_PERLENGKAPAN_IBADAH->setOldValue($CurrentForm->getValue("o_NAMA_PERLENGKAPAN_IBADAH"));
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // NAMA_PERLENGKAPAN_IBADAH
            $this->NAMA_PERLENGKAPAN_IBADAH->setDbValueDef($rsnew, $this->NAMA_PERLENGKAPAN_IBADAH->CurrentValue, "", $this->NAMA_PERLENGKAPAN_IBADAH->ReadOnly);
