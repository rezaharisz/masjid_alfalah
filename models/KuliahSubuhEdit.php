 ...
 * Page class
 */
class KuliahSubuhEdit extends KuliahSubuh
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KuliahSubuhEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("NAMA_PENGISI") ?? Key(0) ?? Route(2)) !== null) {
                $this->NAMA_PENGISI->setQueryStringValue($keyValue);
                $this->NAMA_PENGISI->setOldValue($this->NAMA_PENGISI->QueryStringValue);
            } elseif (Post("NAMA_PENGISI") !== null) {
                $this->NAMA_PENGISI->setFormValue(Post("NAMA_PENGISI"));
                $this->NAMA_PENGISI->setOldValue($this->NAMA_PENGISI->FormValue);
            } else {
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_NAMA_PENGISI")) {
            $this->NAMA_PENGISI->setOldValue($CurrentForm->getValue("o_NAMA_PENGISI"));
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // NAMA_PENGISI
            $this->NAMA_PENGISI->setDbValueDef($rsnew, $this->NAMA_PENGISI->CurrentValue, "", $this->NAMA_PENGISI->ReadOnly);
            ...
            // MATERI_KULIAH_SUBUH
            $this->MATERI_KULIAH_SUBUH->setDbValueDef($rsnew, $this->MATERI_KULIAH_SUBUH->CurrentValue, "", $this->MATERI_KULIAH_SUBUH->ReadOnly);
