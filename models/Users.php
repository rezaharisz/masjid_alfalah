...
class Users extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // name
        $this->name = new DbField('users', 'users', 'x_name', 'name', '`name`', '`name`', 200, 50, -1, false, '`name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // password
        $this->_password = new DbField('users', 'users', 'x__password', 'password', '`password`', '`password`', 200, 20, -1, false, '`password`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // userlevelid
        $this->userlevelid = new DbField('users', 'users', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, 11, -1, false, '`userlevelid`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        if ($Security->canAdmin()) { // System admin
            ...
            if ($curVal != "") {
                ...
                if ($this->userlevelid->ViewValue === null) { // Lookup from database
                    ...
                    $sqlWrk = $this->userlevelid->Lookup->getSql(false, $filterWrk, '', $this, true);
