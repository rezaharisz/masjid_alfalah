 ...
 * Page class
 */
class PerlengkapanIbadahView extends PerlengkapanIbadah
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PerlengkapanIbadahView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("NAMA_PERLENGKAPAN_IBADAH") ?? Route("NAMA_PERLENGKAPAN_IBADAH")) !== null) {
            $this->RecKey["NAMA_PERLENGKAPAN_IBADAH"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("NAMA_PERLENGKAPAN_IBADAH") ?? Route("NAMA_PERLENGKAPAN_IBADAH")) !== null) {
                ...
                $this->RecKey["NAMA_PERLENGKAPAN_IBADAH"] = $this->NAMA_PERLENGKAPAN_IBADAH->QueryStringValue;
            } elseif (Post("NAMA_PERLENGKAPAN_IBADAH") !== null) {
                $this->NAMA_PERLENGKAPAN_IBADAH->setFormValue(Post("NAMA_PERLENGKAPAN_IBADAH"));
                $this->RecKey["NAMA_PERLENGKAPAN_IBADAH"] = $this->NAMA_PERLENGKAPAN_IBADAH->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->NAMA_PERLENGKAPAN_IBADAH->setQueryStringValue($keyValue);
                $this->RecKey["NAMA_PERLENGKAPAN_IBADAH"] = $this->NAMA_PERLENGKAPAN_IBADAH->QueryStringValue;
            } else {
                $returnUrl = "perlengkapanibadahlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "perlengkapanibadahlist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "perlengkapanibadahlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
