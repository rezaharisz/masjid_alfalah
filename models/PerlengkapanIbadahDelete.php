 ...
 * Page class
 */
class PerlengkapanIbadahDelete extends PerlengkapanIbadah
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PerlengkapanIbadahDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("perlengkapanibadahlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("perlengkapanibadahlist"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        if ($deleteRows) {
            ...
            foreach ($rsold as $row) {
                ...
                $thisKey .= $row['NAMA_PERLENGKAPAN_IBADAH'];
