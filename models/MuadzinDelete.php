 ...
 * Page class
 */
class MuadzinDelete extends Muadzin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MuadzinDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("muadzinlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("muadzinlist"); // Return to list
                return;
            }
        }
