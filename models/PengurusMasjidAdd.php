 ...
 * Page class
 */
class PengurusMasjidAdd extends PengurusMasjid
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PengurusMasjidAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "pengurusmasjidview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->ID_PENGURUS->OldValue = $this->ID_PENGURUS->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['ID_PENGURUS'] = $this->ID_PENGURUS->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // TGL_LAHIR
        $this->TGL_LAHIR->setDbValueDef($rsnew, UnFormatDateTime($this->TGL_LAHIR->CurrentValue, 7), CurrentDate(), false);
