 ...
 * Page class
 */
class MuadzinView extends Muadzin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MuadzinView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("NAMA_MUADZIN") ?? Route("NAMA_MUADZIN")) !== null) {
            $this->RecKey["NAMA_MUADZIN"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("NAMA_MUADZIN") ?? Route("NAMA_MUADZIN")) !== null) {
                ...
                $this->RecKey["NAMA_MUADZIN"] = $this->NAMA_MUADZIN->QueryStringValue;
            } elseif (Post("NAMA_MUADZIN") !== null) {
                $this->NAMA_MUADZIN->setFormValue(Post("NAMA_MUADZIN"));
                $this->RecKey["NAMA_MUADZIN"] = $this->NAMA_MUADZIN->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->NAMA_MUADZIN->setQueryStringValue($keyValue);
                $this->RecKey["NAMA_MUADZIN"] = $this->NAMA_MUADZIN->QueryStringValue;
            } else {
                $returnUrl = "muadzinlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "muadzinlist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "muadzinlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
