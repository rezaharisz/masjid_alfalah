 ...
 * Page class
 */
class KuliahSubuhView extends KuliahSubuh
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KuliahSubuhView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("NAMA_PENGISI") ?? Route("NAMA_PENGISI")) !== null) {
            $this->RecKey["NAMA_PENGISI"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("NAMA_PENGISI") ?? Route("NAMA_PENGISI")) !== null) {
                ...
                $this->RecKey["NAMA_PENGISI"] = $this->NAMA_PENGISI->QueryStringValue;
            } elseif (Post("NAMA_PENGISI") !== null) {
                $this->NAMA_PENGISI->setFormValue(Post("NAMA_PENGISI"));
                $this->RecKey["NAMA_PENGISI"] = $this->NAMA_PENGISI->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->NAMA_PENGISI->setQueryStringValue($keyValue);
                $this->RecKey["NAMA_PENGISI"] = $this->NAMA_PENGISI->QueryStringValue;
            } else {
                $returnUrl = "kuliahsubuhlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "kuliahsubuhlist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "kuliahsubuhlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
